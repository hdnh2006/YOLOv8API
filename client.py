...
resp = requests.get('http://0.0.0.0:5000/predict?source=https://atlassafetysolutions.com/wp/wp-content/uploads/2019/06/ppe.jpeg',
                    verify=False)
print(resp.content)

# You can also copy and paste the following url in your browser
'http://0.0.0.0:5000/predict?source=https://atlassafetysolutions.com/wp/wp-content/uploads/2019/06/ppe.jpeg'


# ====================== Public video ====================== #
# (Youtube or any public server). It is not ready (yet) to return all frames labeled while using save_txt=T. So, don't try it!

resp = requests.get('http://0.0.0.0:5000/predict?source=https://www.youtube.com/watch?v=5Mts9GGv3gk&ab_channel=CityofBoston',
                    verify=False)

# You can also copy and paste the following url in your browser
'http://0.0.0.0:5000/predict?source=https://www.youtube.com/watch?v=5Mts9GGv3gk&ab_channel=CityofBoston'
